...
import { List, Skeleton, Avatar, Space, Card, Statistic, Button } from 'antd';
import { Link } from "react-router-dom";
import { RemixContext } from "../helpers"
import { RemixHarvestButton } from ".";


export default function RemixValueHeld(props) {
            ...
            renderItem={(item) => (
                    <List.Item>
                        <Card 
                            ...
                            style={{minWidth:40}}
                            actions={[
                                <RemixHarvestButton remix={props.remix} info={item}/>
                            ]}
                            >
